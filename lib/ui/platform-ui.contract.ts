...
function runPlatformUiContract(): void {
  ...
  assert.ok(["project-huice", "project-weaver", "project-sangfor", "project-sundray", "project-muyuan"].every((id) => seedProjects.some((project) => project.id === id)), "五个企业首发项目必须出现在本地首页投影");
