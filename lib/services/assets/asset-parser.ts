...
export function assertAssetMagic(asset: Pick<AssetRecord, "extension">, bytes: Buffer): void {
  ...
  const valid = asset.extension === ".png" ? isPng : asset.extension === ".jpg" || asset.extension === ".jpeg" ? isJpeg : asset.extension === ".webp" ? isWebp : asset.extension === ".pdf" ? isPdf : asset.extension === ".docx" ? isZip : true;
