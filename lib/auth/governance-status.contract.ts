...
async function run(): Promise<void> {
  ...
  assert.equal(getAuthGovernanceStatus({ EMAIL_PROVIDER: "qq_mail", SMTP_HOST: "smtp.qq.com", SMTP_USER: "member@qq.com", SMTP_PASSWORD: "secret" }).email.loginCode, "configured");
  const configured = getAuthGovernanceStatus({ EMAIL_PROVIDER: "aliyun_enterprise_mail", SMTP_HOST: "smtp.example.com", SMTP_USER: "noreply@example.com", SMTP_PASSWORD: "secret", SMS_PROVIDER: "aliyun_dypns", ALIYUN_SMS_API_URL: "https://sms.example.com", ALIYUN_SMS_ACCESS_KEY_ID: "id", ALIYUN_SMS_ACCESS_KEY_SECRET: "secret", ALIYUN_SMS_SCHEME_NAME: "research", CAPTCHA_PROVIDER: "aliyun", ALIYUN_CAPTCHA_API_URL: "https://captcha.example.com", ALIYUN_CAPTCHA_APP_ID: "id", ALIYUN_CAPTCHA_APP_KEY: "key", ALIYUN_CAPTCHA_SCENE_ID: "research" });
