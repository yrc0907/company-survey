...
const required = ["push2.eastmoney.com", "push2his.eastmoney.com", "RPT_LICO_FN_CPD", "periodReturnPct", "maxDrawdownPct", "TOTAL_OPERATE_INCOME", "PARENT_NETPROFIT", "source_chunk", "document_revision", "needs_verification", "content_hash", "ON CONFLICT (id) DO NOTHING"];
