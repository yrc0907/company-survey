...
const theses = {
  ...
  "有赞": "我判断有赞的关键不是店铺工具数量，而是商家获客、全渠道成交和私域复购闭环。平台流量、商家景气和竞争投放会压缩利润；更可持续的赢法是提升商家经营结果的可测量性，把 AI 经营能力绑定到复购和服务收入，而不是只追求新增商家数。",
  "纷享销客": "我判断纷享销客的壁垒取决于能否把 CRM 变成销售团队日常工作流，而不是增加 AI 聊天入口。竞争来自传统 CRM 的客户存量和大厂协同套件；应优先做行业数据模型、销售过程自动化和实施伙伴认证，缩短上线时间并提高续费。",
  "金蝶": "我判断金蝶的长期变量是云订阅迁移和财务/供应链数据的深度，而不是 ERP 模块数量。迁移期会同时带来收入结构变化和交付成本压力；应把大型客户的行业模板、生态开发者和 AI 决策辅助做成可复用能力，避免被低价项目拖回传统软件模式。",
  "奇安信": "我判断奇安信的政企安全优势依赖信任、服务响应和合规场景的组合。采购周期长、产品线复杂和安全效果难量化是主要压力；赢法是把安全运营结果、应急响应和数据治理做成可审计 SLA，并与云、信创和行业集成商形成联合交付。",
  "安恒信息": "我判断安恒的增长机会在数据安全和 AI+安全的合规刚需，但 AI 产品必须证明降噪、研判或测试效率，否则容易停留在宣传层。竞争策略应聚焦可量化的风险闭环、数据资产治理和持续服务，而不是同时覆盖所有安全品类。",
  "启明星辰": "我判断启明星辰的关键在于把长期安全产品积累与新组织/生态资源协同起来，减少产品线重叠和交付复杂度。未来增长要看整合后的渠道效率、服务收入和现金流，而不是单看并购规模；行业客户的统一运营平台是更合理的合作抓手。",
  "钉钉": "我判断钉钉的优势是组织入口和网络效应，基础协同可以低价甚至免费，但收入必须来自审批、低代码、AI 办公和生态服务的增值层。它面对企业微信、飞书和专业 SaaS 的夹击，真正的护城河是组织数据与开发生态的可迁移性，而不是单个功能领先。",
  "Lark": "我判断 Lark 的核心命题是把全球协作、文档和自动化做成统一工作层；国际化增长同时带来数据驻留、合规、语言和本地生态成本。要赢不能只复制国内协同产品，而要把跨国团队的权限、审计和多区域部署做成默认能力，与本地云和咨询伙伴共建交付。",
