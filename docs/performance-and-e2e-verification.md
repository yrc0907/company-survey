...
| 2026-09-02 | 香港 ECS `47.57.138.55` | 通过 SSH 隧道直连真实 App/数据库，之前 `pnpm test:e2e:platform`：9/9 通过；本地新增全站搜索场景后需在 ESA 公网入口恢复后复跑为 10/10；讨论区加载/匿名登录门槛、作者主页、Star、移动端；OSS 隔离对象真实 Put/Head/Delete 通过。ESA 返回 ICP/525，443 公网验收待人工切换后复跑 |
