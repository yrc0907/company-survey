...
| 日期 | 环境 | 结果 |
| --- | --- | --- |
| 2026-09-02 | 本地开发服务 `http://127.0.0.1:3141` | `pnpm test:e2e:platform`：10/10 通过；包含首页搜索/全站搜索 API、排序、快捷键、项目详情、文件筛选、分享成功/失败反馈、讨论区、助手 `@`/拖放/历史、作者主页/关注入口和 390px 无溢出 |
| 2026-09-02 | 香港 ECS `47.57.138.55` | 发布 `bcaca01` 后通过 SSH 隧道直连真实 App/数据库，`pnpm test:e2e:platform`：10/10 通过；包含全站搜索 API、段落锚点入口、讨论区加载/匿名登录门槛、作者主页、Star、移动端；OSS 隔离对象真实 Put/Head/Delete 通过。迁移 `017_comment_anchors.sql` 已应用。ESA 返回 ICP/525，443 公网验收待人工切换后复跑 |
