...
| 2026-09-02 | 香港 ECS `47.57.138.55` | 发布 `6159548` 后通过 SSH 隧道直连真实 App/数据库，`pnpm test:e2e:platform`：12/12 通过；包含全站搜索 API、段落锚点入口、历史活动时间线、公开 Markdown 导出、讨论区加载/匿名登录门槛、作者主页、Star、移动端；OSS 隔离对象真实 Put/Head/Delete 通过。迁移 `017_comment_anchors.sql`、`018_activity_events.sql`、`019_auth_governance.sql`、`020_comment_attachments.sql` 已应用。评论附件真实上传需登录并依赖 Bucket CORS，未在 E2E 中污染生产对象。ESA 返回 ICP/525，443 公网验收待人工切换后复跑 |
