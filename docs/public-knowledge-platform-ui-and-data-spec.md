...
以下五家公司是当前唯一首发研究对象。每家公司必须先导入来源，再生成结论；不能直接把公司名称和宣传语写成已验证事实。五家报告相互独立，不做默认排名或跨行业评分。
...
项目建议：`慧策掌上先机：电商 ERP 与跨境商家经营研究`。

首批来源包括企业官网、产品文档、公开客户案例、招投标或采购公告、公开访谈和可核验的行业材料。重点记录订单、库存、履约、渠道协同等产品边界，以及客户场景、交付方式、定价线索和竞争压力。非上市公司的收入、客户数、续费率和价格没有独立来源时必须保持 `needs_verification`。

### 10.4 信锐科技

项目建议：`信锐科技：企业网络、无线与物联网产品研究`。

重点记录无线、交换、物联网和网络管理产品的公开能力、适用场景、渠道与交付方式。与深信服的股权或品牌关系只能引用公开工商、公告或公司资料；未被来源证明的关联、产品性能和市场份额不得推断。

### 10.5 牧原食品

项目建议：`牧原食品：生猪养殖、成本曲线与产业链研究`。

重点记录出栏量、销售价格、完全成本、饲料、猪周期、现金流、资产负债和屠宰/产业链布局。该项目不使用 SaaS 客户数、续费率等指标替代农牧经营指标；所有价格和周期数据必须注明地区、期间、单位和统计口径。
