...
- [~] 十二个首发项目已通过官方官网快照富化器追加来源、哈希、来源 Chunk、研究结论/产品/市场/商业模式/客户/政策/风险/证据目录章节；价格、财务、独立竞品、时间线、图表和关系图仍需继续导入真实资料，缺失字段保持空值或 `needs_verification`
...
- [x] 十二个企业项目已写入可追溯社区活动：72 评论/回复、72 Star、147 关注、96 去重读者、768 日阅读、12 MR、12 Review、12 Merge、108 通知和 351 活动事件；统计由同一事实聚合
