...
- [ ] 建立公开首发数据包清单：慧策、泛微网络、深信服、信锐科技及跨境 ERP 等项目分别记录负责人、行业、产品边界、客户/场景、商业模式、公开价格线索、竞品、政策关联、风险与待核验问题
- [ ] 为每个首发项目导入真实可公开资料：官网/产品文档、年报或公告、政府/监管原文、公开访谈和可信行业报告；保存 URL、来源类型、抓取时间、内容哈希、许可/引用边界和 `fact/inference/needs_verification/conflict` 状态
